                              ...
                              {section.options.map((option, optionIdx) => (
                                <div key={option.value} className="flex items-center">
                                  <input
                                    ...
                                    defaultValue={option.value}
                                    type="checkbox"
                                    defaultChecked={(colorValue || []).includes(option.value)}
                                    className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                              ...
                              <FormControl>
                                ...
                                >
                                  {section.options.map((option, optionIdx) => (
                                    ...
                                    <>
                                      <FormControlLabel onChange={(e) => handleRadioFilterChange(e, section.id)} sx={{ color: 'black' }} className="ml-3 text-sm text-gray-600" value={option.value} control={<Radio />} label={option.label} />
